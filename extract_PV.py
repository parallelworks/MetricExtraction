...
solveexoFileAddress='/home/marmar/Dropbox/parallelWorks/weldingProject/paraviewPostProcess/outputs/case0/solve.exo'

casefoam = ExodusIIReader(FileName=solveexoFileAddress)
casefoam.PointVariables = []
casefoam.NodeSetArrayStatus = []
...
casefoam.PointVariables = ['U', 'NT', 'S', 'HFL']
...
latesttime = animationScene1.TimeKeeper.TimestepValues[-1] #GetTimeKeeper().TimestepValues[-1]
